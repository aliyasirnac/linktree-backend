...
public class UpdateCompanyImageCommand : IRequest<UpdateCompanyImageResponse>, ISecuredRequest, ICacheRemoverRequest,
    ILoggableRequest, ITransactionalRequest
{
    ...
    public class
        UpdateCompanyImageCommandHandler : IRequestHandler<UpdateCompanyImageCommand, UpdateCompanyImageResponse>
    {
        ...
        public UpdateCompanyImageCommandHandler(IMapper mapper, CompanyBusinessRules companyBusinessRules,
            ICompanyRepository companyRepository, ImageServiceBase imageService)
        {
            _mapper = mapper;
        ...
        public async Task<UpdateCompanyImageResponse> Handle(UpdateCompanyImageCommand request,
