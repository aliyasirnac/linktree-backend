...
public class GetByIdCompanyQuery : IRequest<GetByIdCompanyResponse>
{
    ...
    public class GetByIdCompanyQueryHandler : IRequestHandler<GetByIdCompanyQuery, GetByIdCompanyResponse>
    {
        ...
        public GetByIdCompanyQueryHandler(IMapper mapper, ICompanyRepository companyRepository,
        ...
        public async Task<GetByIdCompanyResponse> Handle(GetByIdCompanyQuery request,
            CancellationToken cancellationToken)
        {
            Company? company = await _companyRepository.GetAsync(predicate: c => c.Id == request.Id, cancellationToken: cancellationToken, include: c=> c.Include(c=>c.Apps));
