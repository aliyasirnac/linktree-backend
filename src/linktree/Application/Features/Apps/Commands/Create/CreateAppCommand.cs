...
public class CreateAppCommand : IRequest<CreatedAppResponse>, ISecuredRequest, ICacheRemoverRequest, ILoggableRequest, ITransactionalRequest
{
    ...
    public class CreateAppCommandHandler : IRequestHandler<CreateAppCommand, CreatedAppResponse>
    {
        ...
        public CreateAppCommandHandler(IMapper mapper, IAppRepository appRepository,
